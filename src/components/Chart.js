        ...
        <LineChart data={data}>
          ...
          {showSales.unitsSold && (
            <>
              ...
              <YAxis hide={true} yAxisId="unitsSold" domain={[adjustedBase, adjustedHeight + 10]} padding={{ bottom: 140 }} />
            </>
          )}
          {showSales.retailerMargin && (
            <>
              ...
              <YAxis hide={true} yAxisId="retailerMargin" domain={[adjustedBase, adjustedHeight + 2]} padding={{ bottom: 50 }} />
            </>  
          )}
