    ...
    <section className="retail-chart panel">
      ...
      <ResponsiveContainer height={475}>
        <LineChart data={data}>
          ...
          <YAxis hide={true} yAxisId="retailSales" domain={[adjustedBase, adjustedHeight]} padding={{ bottom: 180 }} />
          ...
          {showSales.unitsSold && (
            <>
              ...
              <YAxis hide={true} yAxisId="unitsSold" domain={[adjustedBase, adjustedHeight + 500]} />
            </>
          )}
