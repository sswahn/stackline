    ...
    <section className="retail-chart panel">
      ...
      <ResponsiveContainer height={475}>
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="unitsSold" stroke="#F69244" strokeWidth={4} dot={false} stackId="1" isAnimationActive={false} />
          <Line type="monotone" dataKey="retailerMargin" stroke="#Eb44F6" strokeWidth={4} dot={false} stackId="1" isAnimationActive={false} />
